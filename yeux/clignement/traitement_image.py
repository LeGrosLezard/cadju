...
def sourciles_droit(frame, x1, y1, w1, h1,
    ...
    if sourcile6[0] > sum(Lsourcile61)/len(Lsourcile61) + 20 and\
    sourcile6[1] > sum(Lsourcile62)/len(Lsourcile62) + 20 and\
    sourcile6[2] > sum(Lsourcile63)/len(Lsourcile63) + 20:
        print("YOUHOUUUUUUUUUU")

    elif sourcile6[0] < sum(Lsourcile61)/len(Lsourcile61) - 20 and\
    sourcile6[1] < sum(Lsourcile62)/len(Lsourcile62) - 20 and\
    sourcile6[2] < sum(Lsourcile63)/len(Lsourcile63) - 20:
        print("OK AU DEBUT YAVAIT ECRIT ZOOOOBE")
